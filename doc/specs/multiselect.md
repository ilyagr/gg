...
- Drag-drop targets for changes/hunks (behavior undefined)

## Future Work

### Change Operations (file and hunk)

It should be possible to implement multiselect versions of CopyChanges, CopyHunk, MoveChanges and MoveHunk - but not easy. They'll need to modify subsets of the trees of multiple revisions, corresponding to an operation on the *combined* diff.
